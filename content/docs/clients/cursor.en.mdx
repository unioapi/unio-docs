---
title: Cursor API Setup
description: Configure a UnioAPI API key and custom OpenAI Base URL in Cursor. Follow the setup steps to connect available models and verify API access.
---
